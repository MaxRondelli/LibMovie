...
public class TopRatedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<MovieResults> call = myInterface.listOfMovies("top_rated", MainActivity.API_KEY, MainActivity.LANGUAGE, MainActivity.PAGE, MainActivity.REGION);
    ...
    public void reload(){
        ...
        Call<MovieResults> call = myInterface.listOfMovies("top_rated", MainActivity.API_KEY, MainActivity.LANGUAGE, MainActivity.PAGE);
