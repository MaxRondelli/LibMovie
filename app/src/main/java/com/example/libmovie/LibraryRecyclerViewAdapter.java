...
public class LibraryRecyclerViewAdapter extends RecyclerView.Adapter<LibraryRecyclerViewAdapter.ViewHolder> {
    ...
    LibraryRecyclerViewAdapter(Context context, List<MovieClass> movieList, ItemClickListener clickListener, int layout) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Override
        public void onClick(View view) {clickListener.onItemClick(view, getAdapterPosition());}
    }
