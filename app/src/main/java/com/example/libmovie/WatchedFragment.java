...
public class WatchedFragment extends Fragment implements LibraryRecyclerViewAdapter.ItemClickListener {
                ...
                for (int i = 0; i < id_list.size(); i++) {
                    ...
                    call.enqueue(new Callback<MovieDetails>() {
                        ...
                        public void onResponse(Call<MovieDetails> call, Response<MovieDetails> response) {
                            ...
                            libraryRecyclerViewAdapter.notifyDataSetChanged();
                            libraryRecyclerViewAdapter.setClickListener(WatchedFragment.this);
                            recyclerView.setAdapter(libraryRecyclerViewAdapter);
